            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box">
                        ...
                        <!-- /vehicles/create -->
                        <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/cars/update?id=${idVehicle}">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="manufacturer" name="manufacturer" value="${constructeurVehicle}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="modele" name="modele" value="${modeleVehicle}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="seats" name="seats" value="${seatVehicle}">
                                    </div>
                                </div>
                                <!--
                                <div class="form-group">
